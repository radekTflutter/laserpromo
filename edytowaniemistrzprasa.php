...
<body>
	...
	<div class="centered">
		...
		<div id="logo2">
			...
			<label class="container" style="font-weight: bold;font-size: 18pt">WYBIERZ FORMULARZ DO EDYCJI:</H4>
			</label>
		...
		<?PHP
			...
			if (isset($row["id"])) {
				...
				$link = 'edytowaniemistrzselector.php';
			}
		}
		...
		$results = mysqli_query($conn, "SELECT * FROM nadruki WHERE status='1' AND widoczny=1 ORDER BY id DESC ");
