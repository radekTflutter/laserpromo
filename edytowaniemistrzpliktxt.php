...
<body>
	...
	if (isset($_POST['add'])) {
		$log = 'LOGFILE - EDYTOWANIE MISTRZ PLIK TXT:' . "\r\n" .
	...
	if (isset($_POST['add'])) {
		...
		$sql = " UPDATE nadruki SET nazwaprojekturamka ='" . $_POST["nazwaprojekturamkanew"] . "', usermistrzedit ='" . $user . "', nazwapromocjimistrz='" . $_POST["nazwapromocjimistrz"] . "',
									pliktxtramkamistrz ='" . $_POST["pliktxtramkanew"] . "', pliktxtramkamistrz2 ='" . $_POST["pliktxtramkanew2"] . "', pliktxtramkamistrz3 ='" . $_POST["pliktxtramkanew3"] . "',
									kodyzplikutxt ='" . $_POST["kodyzplikutxt"] . "', uwagimistrz ='" . $_POST["uwagimistrz"] . "', pliktxtzkodami='" . $_POST["pliktxtzkodami"] . "',
									rozpoczeciepromodata ='" . $_POST["rozpoczeciepromodata"] . "', rozpoczeciepromoczas ='" . $_POST["rozpoczeciepromoczas"] . "', ostatniekody ='" . $_POST["ostatniekody"] . "', pierwszekody ='" . $_POST["pierwszekody"] . "',
									zakonczeniepromodata ='" . $_POST["zakonczeniepromodata"] . "', zakonczeniepromoczas ='" . $_POST["zakonczeniepromoczas"] . "', iloscwieczek ='" . $_POST["iloscwieczek"] . "', 
	...
	<div class="centered">
		<form action="edytowaniemistrzpliktxt.php" style="padding:10px 0px;" method="post">
			...
			<div class="centered">
				...
				<div class="col-">
								...
								<div class="w3-card-4 w3-container">
									...
									<div class="w3-section">
										...
										<div class="w3-section">
											...
											<input type="text" class="w3-input" name="nazwapromocjimistrz" id="nazwaprojekturamkanew" value="<?php echo $row['nazwapromocjimistrz']; ?>" style="color:black;font-weight:bold" required class="form-control cols=" 90" rows="2" list="projekty" placeholder="  Wpisz nazwe promocji"></textarea>
										...
										<div class="w3-section">
											<label>INDEKS:</label>
											<input type="text" class="w3-input" name="nazwaprojekturamkanew" id="nazwaprojekturamkanew" value="<?php echo $row['nazwaprojekturamka']; ?>" hstyle="color:black;font-weight:bold" required class="form-control cols=" 90" rows="2" list="projekty" placeholder="  Wpisz nazwe promocji"></textarea>
										...
										<div class="w3-section">
											...
											<input type="date" name="rozpoczeciepromodata" class="w3-input" value="<?php echo $row['rozpoczeciepromodata']; ?>" id="nazwaprojekturamkanew" style="color:black;font-weight:bold;width:55%" required class="form-control cols=" 90" rows="2" list="projekty"></textarea>
											<input type="time" name="rozpoczeciepromoczas" class="w3-input" id="pliktxtramka" value="<?php echo $row['rozpoczeciepromoczas']; ?>" style="color:black;font-weight:bold;width:55%" placeholder="Wpisz nazwe pliku tekstowego" required class="form-control cols=" 90" rows="2" list="projekty"></textarea>

											<label> </label>
										</div>
										<div class="w3-section">
											<label>WYBIERZ PLIK TXT A-D:</label>
											<input name="pliktxtramkanew" class="w3-input" type="file" accept=".txt,.csv" required ref="myFile" value="<?php echo $row['pliktxtramkamistrz']; ?>" @change="selectedFile">
											<input class="w3-input" name="pliktxtramkanewbylo" readonly type="text" ref="myFile" value="<?php echo $row['pliktxtramkamistrz']; ?>" required @change="selectedFile">

											<label> </label>
										</div>
										<div class="w3-section">
											<label>WYBIERZ PLIK TXT B-E:</label>
											<input name="pliktxtramkanew2" class="w3-input" type="file" accept=".txt,.csv" required ref="myFile" value="<?php echo $row['pliktxtramkamistrz2']; ?>" @change="selectedFile">
											<input name="pliktxtramkanew2bylo" class="w3-input" required value="<?php echo $row['pliktxtramkamistrz2']; ?>" type="text" ref="myFile" @change="selectedFile">

											<label> </label>
										</div>
										<div class="w3-section">
											<label>WYBIERZ PLIK TXT C-F:</label>
											<input name="pliktxtramkanew3" class="w3-input" type="file" accept=".txt,.csv" required ref="myFile" value="<?php echo $row['pliktxtramkamistrz3']; ?>" @change="selectedFile">
											<input name="pliktxtramkanew3bylo" class="w3-input" required value="<?php echo $row['pliktxtramkamistrz3']; ?>" type="text" ref="myFile" @change="selectedFile">
							...
							<div class="w3-half4">
								<div class="w3-card-4 w3-container">
									...
									<div class="w3-section">
										...
										<div id="app" v-cloak>
											<input name="kodyzplikutxt" class="w3-input" value="<?php echo $row['kodyzplikutxt']; ?>" type="txt" ref="myFile" @change="selectedFile">

											<input name="pliktxtzkodami" class="w3-input" value="<?php echo $row['pliktxtzkodami']; ?>" accept=".txt,.csv" required type="file" ref="myFile" @change="selectedFile">
									...
									<div class="w3-section">
										...
										<input type="date" name="zakonczeniepromodata" id="nazwaprojekturamkanew" class="w3-input" style="color:black;font-weight:bold;width:55%" value="<?php echo $row['zakonczeniepromodata']; ?>" class="form-control cols=" 90" rows="2" list="projekty" placeholder="Wpisz nazwe projektu"></textarea>
										<input type="time" name="zakonczeniepromoczas" id="pliktxtramka" class="w3-input" value="<?php echo $row['zakonczeniepromoczas']; ?>" style="color:black;font-weight:bold;width:55%" placeholder="Wpisz nazwe pliku tekstowego" class="form-control cols=" 90" rows="2" list="projekty" placeholder="Wpisz nazwe pliku tekstowego"></textarea>
										<label> </label>
									</div>
									<div class="w3-section">
					...
					<input type="submit" name="add" id="zatwierdzindex" style="color:white;font-weight:bold" value="ZATWIERDŹ" action="edytowaniemistrzpliktxt.php" class="btn btn-info"></textarea>
