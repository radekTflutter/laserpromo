...
class PDF extends FPDF
{
    function Header()
    {
        ...
        $this->Cell(276, 5, 'RAPORT PROMOCJI PRASA: TYGODNIOWY', 0, 0, 'C');
        $this->Ln(20);
    }
    function Footer()
    {
...
$baza = "SELECT * FROM nadruki WHERE WEEKOFYEAR(rozpoczeciepromodata) = WEEKOFYEAR(NOW()) AND YEAR(rozpoczeciepromodata) = YEAR(NOW())
