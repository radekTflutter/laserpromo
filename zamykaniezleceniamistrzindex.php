...
<body>
	...
	if (isset($_POST['add'])) {
		$log = 'LOGFILE - ZAMYKANIE ZLECENIA MISTRZ SEKWENCJA:' . "\r\n" .
	...
	if (isset($_POST['add'])) {
		...
		$sql = " UPDATE nadruki SET usermistrzzlecenie ='" . $user . "', 
                        uwagimistrz ='" . $_POST["uwagimistrz"] . "',
                        ostatniekody ='" . $_POST["ostatniekody"] . "', iloscwieczek ='" . $_POST["iloscwieczek"] . "', zakonczeniepromodata ='" . $_POST["zakonczeniepromodata"] . "', zakonczeniepromoczas ='" . $_POST["zakonczeniepromoczas"] . "', status=1, zatwierdzony=0
                        WHERE id='" . $_POST["idform"] . "' AND status=1 ";
	...
	<div class="centered">
		...
		<div class="w3-section">
			...
			<form action="zamykaniezleceniamistrzindex.php" method="post">
		...
		<div class="col-">
						...
						<div class="w3-card-4 w3-container">
							...
							<div class="w3-section">
								...
								<div class="w3-section">
									...
									<input type="text" class="w3-input" name="nazwapromocjimistrz" id="nazwaprojekturamkanew" style="color:black;font-weight:bold" value="<?php echo $row['nazwapromocjimistrz']; ?>" readonly class="form-control cols=" 90" rows="2" list="projekty" placeholder="  Wpisz nazwe promocji"></textarea>
								...
								<div class="w3-section">
									<label>INDEKS:</label>
									<input type="text" class="w3-input" style="text-transform:uppercase;" name="nazwaprojekturamkanew" id="nazwaprojekturamkanew" readonly style="color:black;font-weight:bold" value="<?php echo $row['nazwaprojekturamka']; ?>" readonly class="form-control cols=" 90" rows="2" list="projekty" placeholder="  Wpisz nazwe promocji"></textarea>
								...
								<div class="w3-section">
									...
									<form action="edytowaniemistrzpliktxt.php" method="post">
										...
										<input type="date" name="rozpoczeciepromodata" class="w3-input" id="nazwaprojekturamkanew" readonly style="color:black;font-weight:bold;width:50%" required value="<?php echo $row['rozpoczeciepromodata']; ?>" class="form-control cols=" 90" rows="2" list="projekty"></textarea>
										<input type="time" name="rozpoczeciepromoczas" class="w3-input" id="pliktxtramka" readonly style="color:black;font-weight:bold;width:50%" value="<?php echo $row['rozpoczeciepromoczas']; ?>" placeholder="Wpisz nazwe pliku tekstowego" required class="form-control cols=" 90" rows="2" list="projekty"></textarea>
						...
						<div class="w3-card-4 w3-container">
							...
							<div class="w3-section">
								...
								<form action="edytowaniemistrzpliktxt.php" method="post">
									...
									<input type="text" name="ostatniekody" class="w3-input" id="uwagimistrzaramka" readonly style="color:black;font-weight:bold" value="<?php echo $row['ostatniekody']; ?>" class="form-control cols=" 90" rows="2" list="projekty" placeholder="  Podaj znaki nadruku"></textarea>
									<label> </label>
							</div>
							<div class="w3-section">
								<label>ZAKOŃCZENIE DATA/CZAS:</label>
								<input type="date" name="zakonczeniepromodata" id="nazwaprojekturamkanew" class="w3-input" style="color:black;font-weight:bold;width:50%" required class="form-control cols=" 90" rows="2" list="projekty" placeholder="Wpisz nazwe projektu"></textarea>
								<input type="time" name="zakonczeniepromoczas" id="pliktxtramka" class="w3-input" style="color:black;font-weight:bold;width:50%" required placeholder="Wpisz nazwe pliku tekstowego" class="form-control cols=" 90" rows="2" list="projekty" placeholder="Wpisz nazwe pliku tekstowego"></textarea>
								<label> </label>
							</div>
							<div class="w3-section">
								<label>ILOŚĆ WIECZEK:</label>
								<input type="text" name="iloscwieczek" class="w3-input" id="uwagimistrzaramka" style="color:black;font-weight:bold" class="form-control cols=" 90" required rows="2" list="projekty" placeholder="  Ilość wieczek"></textarea>
								<label> </label>
							</div>
						</div>
					</div>
			...
			<br>
			<input type="submit" name="add" id="zatwierdzindex" style="color:white;font-weight:bold" value="ZATWIERDŹ" action="zamykaniezleceniamistrzindex.php" class="btn btn-info"></textarea>
			</form>
			<br><br>
			<div id="logo5">
