...
<body>
	...
	if (isset($_POST['add'])) {
		$log = 'LOGFILE - EDYTOWANIE MISTRZ SEKWENCJA:' . "\r\n" .
	...
	if (isset($_POST['add'])) {
		...
		$sql = " UPDATE nadruki SET nazwaprojekturamka ='" . $_POST["nazwaprojekturamkanew"] . "', usermistrzedit ='" . $user . "', nazwapromocjimistrz='" . $_POST["nazwapromocjimistrz"] . "',
			iloscwieczek ='" . $_POST["iloscwieczek"] . "', uwagimistrz ='" . $_POST["uwagimistrz"] . "',
			...
			zakonczeniepromodata ='" . $_POST["zakonczeniepromodata"] . "', zakonczeniepromoczas ='" . $_POST["zakonczeniepromoczas"] . "',status=1 WHERE id='" . $_POST["idform"] . "' AND status=1 ";
	...
	<div class="centered">
		...
		<div class="w3-section">
			...
			<form action="edytowaniemistrzindex.php" method="post">
		...
		<div class="col-">
					...
					<div class="w3-half">
						<div class="w3-card-4 w3-container">
							...
							<div class="w3-section">
								...
								<div class="w3-section">
									<label>INDEX:</label>
									<input type="text" class="w3-input" name="nazwaprojekturamkanew" id="nazwaprojekturamkanew" style="color:black;font-weight:bold" value="<?php echo $row['nazwaprojekturamka']; ?>" required class="form-control cols=" 90" rows="2" list="projekty" placeholder="  Wpisz nazwe promocji"></textarea>
					...
					<div class="w3-half4">
						<div class="w3-card-4 w3-container">
							...
							<div class="w3-section">
								...
								<input type="date" name="zakonczeniepromodata" id="nazwaprojekturamkanew" class="w3-input" style="color:black;font-weight:bold;width:50%" value="<?php echo $row['zakonczeniepromodata']; ?>" class="form-control cols=" 90" rows="2" list="projekty" placeholder="Wpisz nazwe projektu"></textarea>
								<input type="time" name="zakonczeniepromoczas" id="pliktxtramka" class="w3-input" style="color:black;font-weight:bold;width:50%" value="<?php echo $row['zakonczeniepromoczas']; ?>" placeholder="Wpisz nazwe pliku tekstowego" class="form-control cols=" 90" rows="2" list="projekty" placeholder="Wpisz nazwe pliku tekstowego"></textarea>
								<label> </label>
							</div>
							<div class="w3-section">
								<label>ILOŚĆ WIECZEK:</label>
								<input type="text" name="iloscwieczek" class="w3-input" id="uwagimistrzaramka" style="color:black;font-weight:bold" value="<?php echo $row['iloscwieczek']; ?>" class="form-control cols=" 90" rows="2" list="projekty" placeholder="  Ilość wieczek"></textarea>
								<label> </label>
							</div>
						</div>
					</div>
			...
			<br>
			<input type="submit" name="add" id="zatwierdzindex" style="color:white;font-weight:bold" value="ZATWIERDŹ" action="edytowaniemistrzindex.php" class="btn btn-info"></textarea>
			</form>
			<br><br>
			<div id="logo5">
